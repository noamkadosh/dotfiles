...
# Nix aliases
alias nixbuild="nix build --out-link ~/result $HOME/Developer/dotfiles/nix#darwinConfigurations.Noam.system"
alias nixswitch="sudo $HOME/result/sw/bin/darwin-rebuild switch --flake $HOME/Developer/dotfiles/nix#Noam"
alias nixupdate="nix flake update --flake ~/Developer/dotfiles/nix/"
